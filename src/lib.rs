...
//! # SPA-SRA
//!
//! The SPA-SRA (Solar Position Algorithm for Solar Radiation Applications) calculates the solar zenith and
...
//!
//! SPA-SRA is a port with rust specific adjustments from the original C-code prepared by employees
